...
- With **Original / Legacy + Original Preset Audio**, the native converter takes the tail directly from seconds 50.000–70.000 of the same official `nam_input_wav.wav`; a separate `PresetAudio.wav` is not required for this exact-default combination.
