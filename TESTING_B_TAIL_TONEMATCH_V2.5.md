...
- SolverV1: minimum-phase 2048-sample IR (v2.5.1 extension; analysis and smoothing unchanged).
- Smooth is fixed at the VST panel default 50%, corresponding to 1/12-octave CAB smoothing.
